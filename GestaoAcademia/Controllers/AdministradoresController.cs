...
using GestaoAcademia.ViewModels;
...
namespace GestaoAcademia.Controllers
{
    public class AdministradoresController : Controller
    {
        ...
        public AdministradoresController(IAdministradorRepository administradorRepository, IHttpContextAccessor httpContextAcessor)
        {
